    ...
    render() {
        return (
            <form id='post-form' onSubmit={this.handleSubmit}>
                ...
                <Input required id='title' type='text' className='cn-title-thread' placeholder='Thread Title'></Input>
                <Label htmlFor='cn-textarea'>Thread Content</Label>
                <Textarea required id='content' className='post-info' placeholder='Ask a question!'></Textarea>
