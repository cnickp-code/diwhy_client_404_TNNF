  ...
  componentDidMount() {
    if (TokenService.hasAuthToken()) {
      ...
      TokenService.queueCallbackBeforeExpiry(() => {
        this.context.fetchRefreshToken();
      });
    };
  };
    ...
    return (
      <div className='App'>
        ...
        {this.context.user.intro && <main>
          ...
          <Switch>
            <PrivateRoute exact path={'/'} component={DashboardRoute} />
            <PrivateRoute path={'/wanted'} component={WantedRoute} />
            <PrivateRoute path={'/wanted-item/:id'} component={HelpWantedItemPage} />
            <PrivateRoute path={'/thread/:id'} component={ThreadItemPage} />
            <PrivateRoute path={'/profile/:user_name'} component={ProfileRoute} />
